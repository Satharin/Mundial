...
public class ConfigTableD {

    public static String[] teams, matches, goals_scored, goals_lost, balances, points;

    public static final String DATA_URL = "https://mundial2018.000webhostapp.com/mundial/getTableD.php";
    ...
    public ConfigTableD(String json){
        this.json = json;
    }

    protected void ConfigTableD() {
