...
public class ConfigTableG {

    public static String[] teams, matches, goals_scored, goals_lost, balances, points;

    public static final String DATA_URL = "https://mundial2018.000webhostapp.com/mundial/getTableG.php";
    ...
    public ConfigTableG(String json){
        this.json = json;
    }

    protected void ConfigTableG() {
