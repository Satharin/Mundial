...
public class ConfigCheckUserBets {
    ...
    public static String[] logins, bets_a, bets_b, bet_dates;
    ...
    public static final String KEY_BETDATE= "bet_date";
    ...
    protected void ConfigCheckUserBets() {
        ...
        try {
            ...
            if (!JSON_ARRAY.equals("null")) {
                ...
                bet_dates = new String[matches.length()];
                ...
                for (int i = 0; i < matches.length(); i++) {
                    ...
                    bet_dates[i] = jo.getString(KEY_BETDATE);
                }
            } else {
                if (logins != null) {
