<?php 
	...
	if($_SERVER['REQUEST_METHOD']=='GET'){
		...
		$sql = "SELECT Teams.name AS team_a, teams_b.team_b, DATE_FORMAT(Matches.date_match, '%d-%m-%Y') AS date_match, TIME_FORMAT(Matches.time_match, '%H:%i') AS time_match, Matches.id_match, Matches.result_a, Matches.result_b FROM Matches
