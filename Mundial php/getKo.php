<?php 
	...
	if($_SERVER['REQUEST_METHOD']=='GET'){
        ...
        WHERE Matches.stage = 'ko' AND IF(Matches.date_match = '".$date."', (Matches.date_match = '".$date."' AND (Matches.time_match > '".$time."' OR Matches.time_match = '".$time."')),Matches.date_match > '".$date."')
